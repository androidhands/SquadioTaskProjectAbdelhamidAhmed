...
import 'package:squadio_task_project_abdelhamid_hamed/features/popular_people/presentation/pages/popular_people_details_page.dart';
...
@MaterialAutoRouter(
    ...
    routes: <AutoRoute> [
      ...
      AutoRoute(page: PopularPeopleDetailsPage),
