...
void init(){
  ...
  sl.registerFactory(() => ActorDetailsBloc(getActorDetailUseCase: sl(), getActorImagesUseCase: sl()));
  ...
  sl.registerLazySingleton<ActorDetailsRepository>(() => ActorDetailsRepositoryImpl(actorDetailsRemoteDataSource: sl(), platformNetworkInfo: sl()));

  //data sources

  sl.registerLazySingleton<PopularPeopleRemoteDataSource>(() => PopularPeopleRemoteDataSourceImpl(sl(), AppConstants.baseUrl));
  sl.registerLazySingleton<ActorDetailsRemoteDataSource>(() => ActorDetailsRemoteDataSourceImpl(sl(),AppConstants.baseUrl));
